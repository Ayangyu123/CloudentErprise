...
class SelectTeamAdapter(var context: Context?, var list:ArrayList<Team>) : RecyclerView.Adapter<SelectTeamAdapter.ViewHolder>(){

    val TAG ="FilesAdapter"
    var mOnRecyclerItemClickListener : OnRecyclerItemClickListener? = null
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        var view = LayoutInflater.from(parent.context).inflate(com.ucas.cloudenterprise.R.layout.item_members, parent,false)
    ...
    class ViewHolder(itemView : View) :RecyclerView.ViewHolder(itemView){
        ...
        var tv_members_count =itemView.findViewById<TextView>(com.ucas.cloudenterprise.R.id.tv_members_count)
        var iv_team_falg =itemView.findViewById<ImageView>(com.ucas.cloudenterprise.R.id.iv_team_falg)
