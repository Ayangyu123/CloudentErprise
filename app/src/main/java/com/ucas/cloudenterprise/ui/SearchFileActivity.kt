...
//                    })
                                ...
                                Log.e("AAA","我是SearchFileActivity里面的下载")
                            }
                            "复制到" -> {
                                Toastinfo("复制到")
...
//                    })
    ...
    private fun ShowRenameDialog(item: File_Bean) {
        ReanmeDialog = Dialog(this@SearchFileActivity).apply {
            var contentview =
                LayoutInflater.from(this@SearchFileActivity)
                    .inflate(R.layout.dialog_file_rename, null)
            contentview.apply {
