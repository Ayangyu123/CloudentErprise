...
class FileListAdapter(
    ...
    inner class FileListItemSingleChoiceHolder(itemView: View) :
        ...
        override fun bind(itemImpl: FileItemBeanImpl, position: Int) {
            ...
            mPosition = position
//            Log.e("ok"," file name"+itemImpl.fileName+" "+Formatter.formatFileSize(activity,itemImpl.size).toUpperCase())
            //TODO 文件大小显示
            mTvFileName.text = itemImpl.fileName+" "+Formatter.formatFileSize(activity,itemImpl.size).toUpperCase()
